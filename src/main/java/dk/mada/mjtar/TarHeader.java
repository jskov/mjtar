...
public final class TarHeader {
    ...
    /// @param buf     the header buffer to write the string into
    ...
    /// @param modTime      the last modification time in numeric Unix time format
    /// @param dir          a flag to mark directory
